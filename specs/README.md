...
| [024-mcp-paper-chunks](./024-mcp-paper-chunks/) | Verified. `get_paper_chunks` pages live indexed body text. |
| [025-mcp-topic-ingest](./025-mcp-topic-ingest/) | Verified. Admin MCP async topic ingest jobs + poll status; Compose `mcp_worker`. |
